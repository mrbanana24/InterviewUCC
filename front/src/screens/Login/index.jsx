...
const Login = () => {
  ...
  return (
    <MuiGrid container sx={{ backgroundColor: "#8FBC8F" }}>
      {/* First half screen with blur and elevation effect */}
      <MuiGrid item xs={12} md={6} sx={{ maxHeight: "100vh", overflow: "hidden" }}>
        <Paper elevation={3} style={{ ...blurStyle, position: "relative", overflow: "hidden" }}>
          ...
          <Grid width={1501} columns={5} gutter={2} borderRadius={9} fetchGifs={fetchGifs} key={searchTag} />
        </Paper>
      </MuiGrid>
      {/* Second half screen */}
